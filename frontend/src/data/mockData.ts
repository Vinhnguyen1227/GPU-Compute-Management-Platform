...
export const mockTransactions: Transaction[] = [
  {
    ...
    description: 'Top up via VietQR banking transfer',
  ...
  },
  {
    ...
    description: 'GPU usage deduction for Llama-3-70B-epoch-2 (H100 x4)',
  ...
  },
  {
    ...
    description: 'Deposit via VNPay Gateway',
  ...
  },
  {
    ...
    description: 'Partial refund for CUDA OOM failed execution',
